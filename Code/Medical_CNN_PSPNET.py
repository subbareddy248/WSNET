...
local_model = PSPNet(backbone_name='densenet121',input_shape=(48, 48, 3),classes=1,activation='sigmoid', encoder_freeze=False)
...
#global_model = PSPNet(backbone_name='mobilenet',input_shape=(192, 192, 3),classes=1,activation='sigmoid', encoder_freeze=False)
