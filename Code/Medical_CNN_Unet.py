...
local_model = Unet(backbone_name='densenet169',input_shape=(64, 64, 3),classes=1,activation='sigmoid', encoder_freeze=False)
...
global_model = Unet(backbone_name='densenet169',input_shape=(192, 192, 3),classes=1,activation='sigmoid', encoder_freeze=False)
